...
import { GetTransfers200Response } from '../model/getTransfers200Response';
...
export class TransfersApi {
     ...
     */
    public async getTransfers (limit?: any, startingAfter?: any, endingBefore?: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetTransfers200Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetTransfers200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "GetTransfers200Response");
     ...
     */
    public async getTransfersTransferId (transferId: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Transfer;  }> {
        const localVarPath = this.basePath + '/v2/transfers/{transfer_id}'
        ...
        if (transferId === null || transferId === undefined) {
            throw new Error('Required parameter transferId was null or undefined when calling getTransfersTransferId.');
        }
