...
Payout methods can be added by a user's account by the user through the UI components provided by Dots. For a more custom integration, you can use the [/v2/users/wallet/add_payout_method](/api#tag/users/paths/~1api~1users~1wallet~1add%5Fpayout%5Fmethod/post) endpoint to do the same.
