...
Apps are useful for multi-tenancy scenarios where you want to separate funds and users on your platform. For example, if your platform has customers with different balances, bank accounts, and users, you can create an app for each customer.
...
- **Creation**: Payouts can be initiated through the Dots API or Dashboard. Dots provides three option to create payouts:
  - [Payout Links](#payout-links)
  - [Flows](#flows)
  - API (Whitelabel)
- **Processing**: Once initiated, Dots processes the payout and ensures the funds are transferred to the user's account using their prefered payment method.
