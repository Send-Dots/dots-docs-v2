...
- **Creation**: Payouts can be initiated through the Dots API or Dashboard. Dots provides three option to create payouts:
  ...
  - [Flows](#flows)
  - API
- **Processing**: Once initiated, Dots processes the payout and ensures the funds are transferred to the user's external account after the
    Tracking: You can track the status of payouts in real-time through the Dots Dashboard or API.
