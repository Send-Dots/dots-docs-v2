...
Every new App has its own App Keys, which you can use to authenticate all operations related to that App. As with the organization key, you will always inform your App key in a token format when using the Dots API. 
